...
def chat_with_survey_data():
    ...
    try:
        ...
        system_prompt += (
            ...
            "8. Length of response: Keep the response very short, concise, and focused. Wrap up the entire response in under 250 words (max 350 tokens) to ensure it is never truncated or cut off."
        )
